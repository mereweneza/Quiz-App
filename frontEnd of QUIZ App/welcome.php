    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                    ...
                    if(@$_GET['q']== 'result' && @$_GET['eid']) 
                    {
                        ...
                        while($row=mysqli_fetch_array($q) )
                        {
                            ...
                            echo '<tr style="color:#66CCFF"><td>Total Questions</td><td>'.$qa.'</td></tr>
                                ...
                                <tr style="color:#66CCFF"><td>Score&nbsp;<span class="glyphicon glyphicon-star" aria-hidden="true"></span></td><td>'.$r.'</td></tr>';
                        }
                        $q=mysqli_query($con,"SELECT * FROM rank WHERE  email='$email' " )or die('Error157');
                        while($row=mysqli_fetch_array($q) )
                        {
                            $s=$row['score'];
                            echo '<tr style="color:#990000"><td>Overall Score&nbsp;<span class="glyphicon glyphicon-stats" aria-hidden="true"></span></td><td>'.$r.'</td></tr>';
                        }
                        echo '</table></div>';
                    }
                ?>
                ...
                ?>
                <center><a href="https://www.facebook.com/"><button>Share Results on facebook</button></a></center><br>
                <center><a href="https://www.instagram.com/"><button>Share Results on Instagram</button></a></center><br>
                <center><a href="https://www.twitter.com/"><button>Share Results on twitter</button></a></center>
</body>
</html>